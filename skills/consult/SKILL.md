...
```bash
bash /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator/bootstrap-env.sh 2>/dev/null; pip3 install -q -r /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator/requirements.txt 2>/dev/null && python3 /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator/consult.py <model> <role> "prompt text"
```
