...
```bash
bash /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator/bootstrap-env.sh 2>/dev/null
pip3 install -q -r /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator/requirements.txt 2>/dev/null
cd /Volumes/1TB External/openclaw/workspace-main/tools/orchestrator && python3 investigate.py <mode> "subject"
```
