#!/usr/bin/env node
/**
 * Batch Fix: Add Organization JSON-LD schema
 * Soli Deo Gloria
 *
 * Adds Organization schema for "In the Wake" publisher.
 */
...
function addOrganizationJsonLd(html) {
  // Skip if already has Organization JSON-LD for "In the Wake"
  if (html.includes('"@type": "Organization"') && html.includes('"name": "In the Wake"')) {
...
async function main() {
  console.log('Batch Fix: Add Organization JSON-LD');
  console.log('====================================\n');
